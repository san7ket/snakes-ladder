...
class SnakesLadder:
    ...
    def __init__(self, snakes, ladder):
        ...
        self.run(crooked, snakes, ladder)
    ...
    def check_snake(self, pos, snakes):
    ...
    def check_ladder(self, pos, ladder):
        """Checks if the current position have a snake and returns to tail
    ...
    def run(self, crooked, snakes, ladder):
        ...
        for i in range(1, 10):
            ...
            pos = pos + dice
            print("Current Position:{0}".format(pos))
            final_pos = self.check_ladder(pos, ladder)
            final_pos = self.check_snake(pos, ladder)
            pos = final_pos
            print("\n")
            if pos >= 100:
